...
const EKGTracing: React.FC<EKGTracingProps> = ({ 
  ...
  const getPathForLead = (lead: string): string => {
    ...
    // Center the P-QRS-T complex horizontally in the viewBox
    const leftPadding = (viewBoxWidth - totalWaveformWidth) / 2; // Center the waveform
    
    // Calculate positions with the waveform centered
    ...
    if (qrsDeflection) {
      ...
      switch (lead) {
        case 'I':
          ...
          path += `Q ${tWaveStart + tWaveWidth/2} ${tWaveHeightI} ${tWaveEnd} ${baseY} `;
          break;
        ...
        case 'II':
          ...
          path += `Q ${tWaveStart + tWaveWidth/2} ${tWaveHeightII} ${tWaveEnd} ${baseY} `;
          break;
        ...
        case 'III':
          ...
          path += `Q ${tWaveStart + tWaveWidth/2} ${tWaveHeightIII} ${tWaveEnd} ${baseY} `;
          break;
        ...
        case 'aVR':
          ...
          path += `Q ${tWaveStart + tWaveWidth/2} ${tWaveHeightAVR} ${tWaveEnd} ${baseY} `;
          break;
        ...
        case 'aVL':
          ...
          path += `Q ${tWaveStart + tWaveWidth/2} ${tWaveHeightAVL} ${tWaveEnd} ${baseY} `;
          break;
        ...
        case 'aVF':
          ...
          path += `Q ${tWaveStart + tWaveWidth/2} ${tWaveHeightAVF} ${tWaveEnd} ${baseY} `;
          break;
